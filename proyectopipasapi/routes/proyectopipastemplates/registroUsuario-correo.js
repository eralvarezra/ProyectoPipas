...
this.enviar_email = (pnombre_completo, pcorreo) => {
    ...
    let email_options = {
        ...
        <table cellpadding="0" cellspacing="0" width="600px" background-color="rgb(255,255,255)" ; bgcolor="#cc494f" ;>
            <tr height=" 70px ">
                <td width="600px ">
                    <h1 style="color:#fff; text-align:center ">Bienvenido a PetLover</h1>
        ...
        <tr>
            <td style="text-align:center">
                <p style="color:#fff;">Ingrese <a href="http://127.0.0.1:5502/proyectopipashtml/cambiarContrasenna.html?correo=${pcorreo}">aquí</a> para cambiar su contraseña</p>
            </td>
        </tr>
    </table>`
    };
