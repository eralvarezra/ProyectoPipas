    ...
    let email_options = {
        ...
        <tr>
            <td style="text-align:center ">
                <p style="color:  #fff; ">Ingrese <a href="http://127.0.0.1:5501/ProyectoPipas/proyectopipashtml/cambiarContrasenna.html?user_name=${pnombre_completo} ">aquí</a> para cambiar su contraseña</p>
            </td>
        </tr>
    </table>`
    };
